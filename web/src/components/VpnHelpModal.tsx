      ...
      {blocked ? (
        ...
        <div className="mb-5 rounded-xl border border-blue-200 bg-blue-50 p-4">
          ...
          <p className="mt-2 text-sm leading-relaxed text-blue-800">
            หากคุณอยู่ในสำนักงาน หรือเชื่อมต่อ VPN อยู่แล้ว กด &ldquo;อยู่ในเครือข่ายแล้ว เปิดเลย&rdquo;
            — หากอยู่นอกสำนักงาน ให้เชื่อมต่อ VPN ตามขั้นตอนด้านล่างก่อน มิฉะนั้นจะเปิดหน้าไม่ขึ้น
          </p>
        </div>
      )}
