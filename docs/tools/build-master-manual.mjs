...
const ch6 = [
  ...
  p('การ์ดเดียวกันมีช่อง "ชื่อ DynDNS / IP สาธารณะของบริษัท" ซึ่งพอร์ทัลใช้ตัดสินว่าผู้ใช้อยู่ในเครือข่ายบริษัทหรือไม่ ' +
    'ต้องใส่ชื่อของทุกวงจรอินเทอร์เน็ต (WAN) ที่บริษัทใช้ออกเน็ต คั่นด้วยช่องว่าง เพราะเครื่องใน LAN กับเครื่องที่ต่อ VPN ' +
    'อาจออกอินเทอร์เน็ตคนละเส้นกัน และ VPN ต้องเป็นแบบ full tunnel มิฉะนั้นไอพีสาธารณะจะไม่เปลี่ยนและพอร์ทัลจะถือว่าผู้ใช้อยู่นอกเครือข่าย'),
  p('รายละเอียดทั้งหมด — วิธีทำงาน ค่าที่ใช้จริง การตั้งค่าอุปกรณ์ VPN และการแก้ปัญหา — อยู่ในเอกสาร docs/NETWORK-CHECK-AND-VPN.md ของ repository'),
  ...
  ...table(
    ...
    [
      ...
      [
        ...
        'พักไว้ — มีทางแก้ชั่วคราวแล้ว',
        'ปัจจุบันมีแอป intranet จริงบนพอร์ทัลแล้ว (osTicket ระดับ A ผ่าน HTTP) พอร์ทัลจึงตรวจสถานะด้วย Health Endpoint ไม่ได้ ' +
          'และใช้วิธีเทียบไอพีสาธารณะกับชื่อ DynDNS ของบริษัทแทน (ดู docs/NETWORK-CHECK-AND-VPN.md) ' +
          'เมื่อทำ HTTPS เสร็จตาม SSO-OPS-002 จึงจะกลับมาใช้ป้ายสถานะสดได้',
      ],
      [
